...
**IN PROGRESS 2026-08-20 (Junaid) - handoff inversion found: the funnel hands over every failure and drops every success. Building the fix.** Three findings, all verified by reading the deployed source and the live `communications` rows. No live system touched, no secret, no deploy.
