...
- [ ] **Decide whether to unsuspend Syed Hamza** (`hsyed9050@gmail.com`). His profile exists and his number `923201946494` is now set, but he is `is_active=false, is_suspended=true`, so the webhook correctly skips him. Unsuspending puts him straight into rotation. Muhammad was asked and has not answered yet.
